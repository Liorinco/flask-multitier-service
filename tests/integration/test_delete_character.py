...
def test_remove_character_with_hat(
    client, persisted_character_with_hat_dto, character_repository, garment_repository
):
    response = client.delete(f"/characters/{str(persisted_character_with_hat_dto.id)}")
